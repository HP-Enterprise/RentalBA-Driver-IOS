...
+(void)pushControllerFrome:(UIViewController*)controller toController:(UIViewController*)secandController {
    
    if (!controller) {
        
        controller = [DBcommonUtils getCurrentVC];
        ...
        if ([controller isKindOfClass:[UINavigationController class]]) {
            ...
            if (!secandController) {
                ...
                [nav pushViewController:secandController animated:YES];
        ...
        if (!secandController) {
            ...
            [controller.navigationController pushViewController:secandController animated:YES];
